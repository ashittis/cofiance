import { FloatingCard, Avatar } from "./FloatingCard";
import { StarLogo } from "./StarLogo";

export function HeroVisual() {
  return (
    <div className="mx-auto mt-12 max-w-6xl">
      <div className="relative aspect-[16/9] w-full overflow-hidden rounded-[20px] bg-hero-gradient">
        {/* Soft cloud blobs */}
        ...
        <FloatingCard delay={0} className="left-[6%] top-[58%] w-60">
        ...
        <FloatingCard delay={0.15} className="right-[6%] top-[18%] flex items-center gap-2">
          <Avatar initials="DP" />
        ...
        <FloatingCard delay={0.3} className="bottom-[8%] right-[10%] w-64">
          <div className="mb-2 flex items-center justify-between">
            <Avatar initials="AP" />
            <div className="flex items-center gap-1.5">
              <StarLogo className="h-4 w-4 text-ink" />
