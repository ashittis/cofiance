    ...
    <div ref={ref} className="relative overflow-hidden">
      ...
      <Section className="relative pb-8 pt-16 lg:pt-20">
        <div className="max-w-3xl">
          ...
          >
            A workforce engine you can see{" "}
          ...
          <motion.p {...rise(0.3)} className="mt-5 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
            We don&apos;t just send people. We run a closed loop (recruit, screen, train, deploy and
            monitor) so the quality you&apos;re promised is the quality that shows up.
          </motion.p>
